...
public class study extends TabActivity implements TabHost.TabContentFactory{
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		this.setTitle("Learning-"+book.getName());
        //
        LayoutInflater.from(this).inflate(R.layout.studyword_main, th.getTabContentView(), true);
        
        
        th.addTab(th.newTabSpec("studid").setIndicator("UNLEARNT LIST",study.this.getResources().getDrawable(R.drawable.not_learn)).setContent(this));
        th.addTab(th.newTabSpec("all").setIndicator("All AWLs",study.this.getResources().getDrawable(R.drawable.all)).setContent(this));
    }
  			     ...
  			     public void onItemClick(AdapterView<?> arg0, View v, int position,
        			...
        			lv.setOnItemLongClickListener(new OnItemLongClickListener(){
     				...
     				public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
     		            ...
     		            .setTitle("OPERATION")
     		            .setItems(new String[]{"TAGGED TO HAVE BEEN LEARNED"}, new DialogInterface.OnClickListener(){
 	...
 	private void startStudy(final int arg2,final int tag,final int check) {
 		if(tag==2){
 			if(check==1){
 		        ...
 		        .setIcon(R.drawable.dialog_icon)
 		        .setTitle("REMIND")
 		        .setMessage("THIS CHPATER HAS BEEN LEARNED£¬RE-LEARN WILL EMPTY THE LEARNING RECORD£¬OK£¿\nLIST-"+(arg2+1))
